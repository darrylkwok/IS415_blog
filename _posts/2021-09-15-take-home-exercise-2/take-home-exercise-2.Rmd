...
plot((density(split(rescale(bishan_2019_marked_ppp, 1000)))), main = 'Downtown Core')
...
plot((density(split(rescale(woodlands_2019_marked_ppp, 1000)))), main = 'Hougang')
```
...
plot((density(split(rescale(bishan_2021_marked_ppp, 1000)))), main = 'Downtown Core')
...
plot((density(split(rescale(woodlands_2021_marked_ppp, 1000)))), main = 'Hougang')
```
